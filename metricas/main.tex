...
\begin{abstract}
De a cuerdo a World internet usage and poblation statistics, aproximadamente un 54.4\% tienen acceso a internet (https://www.internetworldstats.com/stats.htm) [1]; gracias a esto, cada vez mas las barreras fisicas para el uso de información cada vez son menores.
La información, es un recurso vital y como tal debe ser protegido; sin embargo dicha tarea es cada vez mas desafiante debido la mayor facilidad, numero y sofisticación de los ataques que se lanzan en la actualidad. Para hacer frente estos ataques se han creado diferentes herramientas de seguridad como firewalls, antivirus, IDS e IPS entre otros.

Un sistema de seguridad puede ser visto como una caja negra con unas entradas (datos de red: trafico de red, logs, reportes de hardware), unas salidas (alarmas, reportes de red, logs) y un proceso, cuya finalidad es actuar sobre las entradas, procesarlas y generar las salidas necesarias. El presente tratara con mas detalle los aspectos relacionados con las entradas ya que estas, constituyen el punto de partida en el proceso de diseño de un sistema de seguridad.
...
\begin{enumerate}
\item Describir a grandes rasgos el diagrama de bloques del sistema de seguridad.
\item Hacer un estudio breve de las entradas al sistema y de todos aspectos relacionados con estas haciendo enfasis en los casos en los que se produce un ataque de denegación de servicio.
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[scale=0.3]{modelo_TCP_IP2.png}\\[1cm] % Include a department/university logo - this will require the graphicx package
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[scale=0.3]{TCP_header.png}\\[1cm] % Include a department/university logo - this will require the graphicx package
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[scale=0.3]{UDP_header.png}\\[1cm] % Include a department/university logo - this will require the graphicx package
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[scale=0.3]{ICMP_header.png}\\[1cm] % Include a department/university logo - this will require the graphicx package
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[scale=0.3]{IPv4_header.png}\\[1cm] % Include a department/university logo - this will require the graphicx package
