...
\begin{abstract}
El desarrollo de un sistema de seguridad puede tomar como punto inicial el modelo caja negra lo cual implica inicialmente la definición de unas entradas y salidas. Posteriormente lo que se define es el proceso que determinara la interaccion entre estas. El presente reporte se centra en el analisis de las entradas resaltando principalemente las medidas secundarias que se pueden obtener de estas. Estas, conocidas como metricas en nuestro caso, son importantes por que definen vectores caracteristicos previos a la etapa de procesamiento. 
